...
| `/mm update` | (скрипт обновления) | Обновить mm-систему (git pull + register-skills) |
...
- **`/mm update`** — запусти скрипт обновления: `python3 <repo_root>/scripts/auto-update.py --force` (где <repo_root> из MM_REPO_ROOT или ~/.markdown-memory).
