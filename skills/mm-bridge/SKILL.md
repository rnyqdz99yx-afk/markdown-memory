...
**Иначе auto-detect** по эвристикам из текста задачи:

| Сигнал | Framework |
|---|---|
| Содержит «ревью», «посмотри», «оцени», «review», «critique» | **PERSONA** |
| Содержит «не работает», «падает», «bug», «ошибка», «error», «debug» | **HYPOTHESIS** |
| Длина задачи > 200 символов ИЛИ ≥3 шага в «Что нужно сделать» ИЛИ затрагивает ≥3 файла | **XML** |
| Длина < 50 символов И один файл | **none** |
| Иначе | **CRISPE** |
